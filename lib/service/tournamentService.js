    ...
    engine.getMatchesToReport(tournament.bracket, function(err, matchesToReport){
        if(!err) {
            ...
            _.each(matchesToReport, function (match) {
                if(match.player1.name === req.body.playerInMatch1.name || match.player1.name === req.body.playerInMatch2.name){
                    playersToSwap.push(match);
                }
                if(match.player2.name === req.body.playerInMatch1.name || match.player2.name === req.body.playerInMatch2.name){
                    playersToSwap.push(match);
                }
            });
