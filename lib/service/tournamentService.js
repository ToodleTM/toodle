...
TournamentService.prototype.swapPlayers = function (req, res, tournament, TournamentModel) {
    var engine = this.getTournamentEngine(tournament.engine);
    var self = this;
    var matchesToReport = _.filter(tournament.bracket, function (match) {
    ...
    if (this.areSwapParametersValid(req.body.playerInMatch1, req.body.playerInMatch2)) {
        ...
        var match1ToSwapFrom = self.selectPlayerMatch(matchesToReport, req.body.playerInMatch1.name, req.body.playerInMatch1.number, req.body.playerInMatch1.isPlayer1);
        if (match1ToSwapFrom) {
            matchesContainingPlayersToSwap.push(match1ToSwapFrom);
        }
        var match2ToSwapFrom = self.selectPlayerMatch(matchesToReport, req.body.playerInMatch2.name, req.body.playerInMatch2.number, req.body.playerInMatch2.isPlayer1);
        if (match2ToSwapFrom) {
