...
SimpleGSLGroups.prototype.meta = {version: '1.1', description: 'Simple GSL pools (SC2 GSL Format)', compatible: [], name:'simpleGSLGroups'};
...
SimpleGSLGroups.prototype.reportWin = function (matchNumber, score_1, score_2, groups, matchComplete, callback) {
        ...
        if (!matchComplete || score1 !== score2) {
            ...
            if (match) {
                ...
                if (tryingToReportRound2WhenRound1IsNotOver(matchNumberInGroup, groups, groupNumber) || match.round === 3 && notDeciderMatchesToReport.length > 0) {
                    ...
                    updateMatch(match, score1, score2, matchComplete);
