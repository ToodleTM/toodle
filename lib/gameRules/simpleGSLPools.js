...
SimpleGSLPools.prototype.getPlayersOrderedByScore = function(group, callback){
    if(group.players){
...
SimpleGSLPools.prototype.getWinnersFromGroup = function(group, groupNumber, callback){
    this.getPlayersOrderedByScore(group, function(err, orderedPlayers){
        if(err){
            callback(err);
