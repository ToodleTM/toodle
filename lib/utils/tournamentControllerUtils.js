...
var tournamentIsRunningAndUserWantsToChangeEngineType = function (tournamentData, tournamentDataFromRequestBody) {
    return tournamentData.running && tournamentData.engine !== tournamentDataFromRequestBody.engine;
};
    ...
    if (serverUtils.isThisTournamentIdValid(tournamentDataFromRequestBody._id)) {
        TournamentModel.findById(tournamentDataFromRequestBody._id, function (err, tournamentData) {
            if (err) {
                ...
                if (tournamentIsRunningAndUserWantsToChangeEngineType(tournamentData, tournamentDataFromRequestBody)) {
