...
exports.initLoginFlow = function(req, res, next) {
    ...
    if (req.query.type === 'twitter') {
        ...
        res.redirect('https://accounts.google.com/o/oauth2/auth?scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fplus.login&state=' + state + '&redirect_uri=http://127.0.0.1:9042/gplus_callback&response_type=code&client_id=354676151765-0luptuaa6jh59isk36ujogar6552f9no.apps.googleusercontent.com');
    }
};
