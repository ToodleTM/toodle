...
exports.initLoginFlow = function(req, res, next) {
    var cleanedUpReturnUrl = url.parse(req.query.returnUrl, true);
    delete cleanedUpReturnUrl.query.loginError;
    delete cleanedUpReturnUrl.search;
    req.session.returnUrl = url.format(cleanedUpReturnUrl);
...
exports.fail = function(req, res){
    var redirectUri = url.parse(req.session.returnUrl, true);
    if(!redirectUri.query){
        redirectUri.query = {};
    }
    delete redirectUri.search;
