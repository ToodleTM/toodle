...
exports.update = function (req, res, next) {
    var tournamentService = new TournamentService();
    tournamentControllerUtils.updateTournament(req, res, serverUtils, req.body, tournamentService, this.tournament(), next);
};
...
exports.updatePlayers = function (req, res) {
    var tournamentService = new TournamentService();
    this.tournament().find({signupID: req.body.signupID}, function (err, data) {
...
exports.start = function (req, res) {
    ...
    if (serverUtils.isThisTournamentIdValid(req.body.tournamentId)) {
        this.tournament().findById(req.body.tournamentId, function (err, data) {
            if (errorOrTournamentNotFound(err, data)) {
                return res.json(404);
            } else {
