...
function copyAppSource {
    ...
    for pattern in *.{ico,txt} .htaccess i18n/*.json images/*.png images/toodle.png images/toodle_simple.png images/flags images/people images/social scripts/app.min.js views/index.packed.html views/404.html views/partials views/resources/factions.json views/maintenance/index.html config/piwik.config.js ; do
